...
public class Alumne extends AppCompatActivity {
    ...
    private List<Assignatura> assig;
    /**
    ...
    public Alumne(String nom, int edat, String especialitat, Date fechaNeixament, String sexe, Bitmap foto, List<Assignatura> assig) {
        this.nom = nom;
        this.edat = edat;
